...
USERMSG tx_usermsg;
    ...
    if(cli != NULL)
    {
        ...
        // TODO enter your function which handles data from a web browser HERE
        // pointer to the null terminated text string ... msg
        // the function handling the received data MUST be Thread Safe (!)
        // it's best to use a fifo (also included in this library)
